            ...
            <div class="left-info">
              <div class="header">
                ...
                <div class="name-phone">
                  <a target="_blank" href="/admin/customer">
                    <h6 class="name-cus">Chị Oanh</h6>
                    <h6 class="phone-cus">- 094594553</h6>
                  </a>
                </div>
              </div>
                        ...
                        <div class="dialog-header">
                          ...
                          <FormAddress v-if="basic">
                            ...
                            <div class="m-header">
                              ...
                              <div class="btn-close">
                                <i class="pi pi-times" @click="basic = false"></i>
                              </div>
                              ...
                              <FormEditAddress v-if="basic1">
                                <template v-slot:title>
                                    <div class="m-header-edit">
                                      ...
                                      <div class="btn-close">
                                        <i class="pi pi-times" @click="basic1 = false"></i>
                                      </div>

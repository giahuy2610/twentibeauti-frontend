<template lang="">
    <span class="input p-input-icon-left">
        ...
        <InputText v-if="getEventPromoItem._appliedMode == 'B'"  @input="onShow" placeholder="Tìm kiếm danh mục" /> <!--v-model="filters['global'].value"!-->
        <InputText v-if="getEventPromoItem._appliedMode == 'C'" @input="onShow" placeholder="Tìm kiếm sản phẩm" />
    </span>

...
<div class="image-product">
    <div class="scroll-wrapper" ref="wrapper">
        <button @click="scrollUp(), (isClick = !isClick)" class="pag__btn btn__up">
            ...
            <div class="slick-slider">
                <div class="slick-list">
                    ...
                    scrollTo(index),
                      (isClick = !isClick),
                      (selectedItem = index)
                  " class="pag__size pag__item" :style="{
        ...
        <button @click="scrollDown(), (isClick = !isClick)" class="pag__btn btn__down">

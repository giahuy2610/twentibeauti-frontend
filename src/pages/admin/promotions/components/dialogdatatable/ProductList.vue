<template>
<div>
    <div v-if="getPromoItem._appliedMode == 'B'" class="collection">
        ...
        <DataTable :value="collections" v-model:selection="getPromoItem._collection" dataKey="id" :filters="filters" :globalFilterFields="['name', 'code']" filterDisplay="menu" responsiveLayout="scroll">
            <template #header>
    ...
    <div v-if="getPromoItem._appliedMode == 'C'" class="product">
        <div class="flex justify-content-end mt-1 mb-3">
            <Button icon="pi pi-external-link" label="Nested Dialog" class="p-button-outlined p-button-success" @click="showInfo" />
        </div>
